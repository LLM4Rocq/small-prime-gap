...
`Print Assumptions maynard_M105_certified_alt` reports *Closed
...
witness against pure-Z arithmetic (`CertQuad`). Only the Rocq
...
**`CertQuad.v`** (438 lines). The headline file. Structure in
sections:
...
`CertQuad.v` reports a single line: *Closed under the global
...
Item 5 (strict Rayleigh-quotient bound at v_witness)
  ...
  CertQuad.v   quad_cell_identity, quad_spec_eq_Z,
