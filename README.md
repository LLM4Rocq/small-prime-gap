...
by CertL2.v.  CertL2.v itself has 3 axioms and 4 admits, all with
known closure paths requiring ~370 new lines + compile time on a
machine with >= 8 GB RAM.  See TODO.md for the detailed closure plan.
...
|
+-- TODO.md                         closure plan for remaining axioms/admits
+-- theories/S1/                    19 Rocq files
    ...
    +-- CertL2.v                    L2 assembly (3 axioms, 4 admits; see TODO.md)
...
# 3. Build all Rocq files (~20 min, mostly CharPolyAgree CRT checks)
...
# See TODO.md for how to close the remaining axioms/admits.
```
...
- CertL2.v has 3 axioms + 4 admits (all with known closure paths; see TODO.md)
