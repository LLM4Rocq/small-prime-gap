...
+-- _CoqProject                     18 .v files in dependency order
|
...
+-- theories/S1/                    18 Rocq files
    ...
    +-- Cert.v                      headline theorem (1 admit)
```
...
# 3. Build all 18 Rocq files (~20 min, mostly CharPolyAgree CRT checks)
...
- 1 Admitted lemma: `charpoly_int_Dq_scaled` (shipped poly = D_q * char_poly)
- All sub-components of this admit are individually Qed (see STATUS.md)
