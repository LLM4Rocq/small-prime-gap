...
(* # MaynardVerify                                                          *)
(*                                                                          *)
(* Kernel-verified agreement between the shipped integer matrices           *)
(* (`M1_int`, `M2_int` in `Witness.v`, divided by `D_M1`, `D_M2`) and       *)
(* Maynard's closed-form specification from `MaynardSpec.v`.                *)
(*                                                                          *)
...
(* `all_match_M2Z_true` reports `Closed under the global context`.          *)
(****************************************************************************)
...
Proof. exact: List.forallb_app. Qed.
...
Proof.
by rewrite /all_match_M2Z seq_split_42 !M2_check_rows_app
   M2_check_rows_0_6 M2_check_rows_7_13 M2_check_rows_14_20
